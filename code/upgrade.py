...
class Upgrade:
    ...
    def display(self):
        ...
        for index, item in enumerate(self.item_list):
            ...
            values = self.player.get_value_by_index(index)
            max_value = self.max_values[index]
            cost = self.player.get_cost_by_index(index)

            item.display(self.display_surface, self.selection_index, name, values, max_value, cost)
...
class Item:
    ...
    def display_names(self, surface, name, cost, value, selected):
        ...
        title_rect = title_surf.get_rect(midtop=self.rect.midtop + pygame.math.Vector2(10,20))
        surface.blit(title_surf, title_rect)

        cost_surf = self.font.render(f'{int(value)} UP({int(cost)}exp)', False, color)
    ...
    def display(self, surface, selection_num, name, value, max_value, cost):
        ...
        self.display_names(surface,name,cost, value, self.index == selection_num)
